...
// AppealReview implements v1.ReviewClient.
func (x *Registry) AppealReview(ctx context.Context, in *v1.AppealReviewRequest, opts ...grpc.CallOption) (*v1.AppealReviewReply, error) {
	panic("unimplemented")
}

// AuditReview implements v1.ReviewClient.
func (x *Registry) AuditReview(ctx context.Context, in *v1.AuditReviewRequest, opts ...grpc.CallOption) (*v1.AuditReviewReply, error) {
	panic("unimplemented")
}

// CreateReview implements v1.ReviewClient.
func (x *Registry) CreateReview(ctx context.Context, in *v1.CreateReviewRequest, opts ...grpc.CallOption) (*v1.CreateReviewReply, error) {
	panic("unimplemented")
}

// DeleteReview implements v1.ReviewClient.
func (x *Registry) DeleteReview(ctx context.Context, in *v1.DeleteReviewRequest, opts ...grpc.CallOption) (*v1.DeleteReviewReply, error) {
	panic("unimplemented")
}

// GetReview implements v1.ReviewClient.
func (x *Registry) GetReview(ctx context.Context, in *v1.GetReviewRequest, opts ...grpc.CallOption) (*v1.GetReviewReply, error) {
	panic("unimplemented")
}

// ListReviewByUserID implements v1.ReviewClient.
func (x *Registry) ListReviewByUserID(ctx context.Context, in *v1.ListReviewRequest, opts ...grpc.CallOption) (*v1.ListReviewReply, error) {
	panic("unimplemented")
}

// ReplyReview implements v1.ReviewClient.
func (x *Registry) ReplyReview(ctx context.Context, in *v1.ReplyReviewRequest, opts ...grpc.CallOption) (*v1.ReplyReviewReply, error) {
	panic("unimplemented")
}
